...
namespace CloudWay_LMS.BLL
{
    public class CategoryBLL
    {
        ...
        private void Validate(Category c)
        {
            ...
            if (string.IsNullOrWhiteSpace(c.Name)) throw new ValidationException("Category name is required.");
            c.Name = c.Name.Trim();
            if (c.Name.Length > 60) throw new ValidationException("Category name must be 60 characters or fewer.");
