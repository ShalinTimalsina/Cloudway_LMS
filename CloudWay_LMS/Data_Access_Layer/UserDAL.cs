...
namespace CloudWay_LMS.Data_Access_Layer
{
    ...
    public class UserDAL
    {
        ...
        private const string SelectColumns = @"
                ...
                u.RoleID, u.IsActive, u.CreatedAt, u.RememberToken, u.RememberTokenExpiry,
        ...
        {
            const string sql = @"
                INSERT INTO Users (FullName, Email, PasswordHash, PasswordSalt, RoleID, IsActive, CreatedAt)
                VALUES (@FullName, @Email, @PasswordHash, @PasswordSalt, @RoleID, 1, SYSUTCDATETIME());
        ...
        private User Map(SqlDataReader r)
        {
            return new User
            {
                ...
                RememberToken = DbHelper.GetString(r, "RememberToken"),
                RememberTokenExpiry = DbHelper.GetNullableDate(r, "RememberTokenExpiry"),
