<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Admin.master" CodeBehind="ManageLessons.aspx.cs" Inherits="CloudWay_LMS.Admin.ManageLesson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <asp:PlaceHolder ID="phCourseTools" runat="server" Visible="false">
        <div class="admin-panel">
            ...
            <div class="form-field">
                <label for="<%= txtDurationOldOld.ClientID %>">Duration (minutes)</label>
                <asp:TextBox ID="txtDurationOldOld" runat="server" CssClass="form-control" TextMode="Number" />
            </div>
