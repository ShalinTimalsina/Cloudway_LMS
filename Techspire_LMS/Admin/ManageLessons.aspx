<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Admin.master" CodeBehind="ManageLessons.aspx.cs" Inherits="Techspire_LMS.Admin.ManageLesson" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContent" runat="server">
    ...
    <asp:PlaceHolder ID="phCourseTools" runat="server" Visible="false">
        <div class="admin-panel">
            ...
            <div class="form-field">
                <label for="<%= txtSortOrder.ClientID %>">Sort order</label>
                <asp:TextBox ID="txtSortOrder" runat="server" CssClass="form-control" TextMode="Number" Text="1" />
            </div>
            <div class="form-field">
