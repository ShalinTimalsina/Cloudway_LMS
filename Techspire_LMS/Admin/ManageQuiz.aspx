<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Admin.master"  CodeBehind="ManageQuiz.aspx.cs" Inherits="Techspire_LMS.Admin.ManagaeQuiz" %>
    ...
    <asp:PlaceHolder ID="phQuizPanel" runat="server" Visible="false">
        <div class="admin-panel">
            ...
            <div class="form-field" style="max-width:200px;">
                <label for="<%= txtPassMark.ClientID %>">Pass mark (%)</label>
                <asp:TextBox ID="txtPassMark" runat="server" CssClass="form-control" TextMode="Number" Text="50" />
            </div>
        ...
        <div class="admin-panel">
            <asp:GridView ID="gvQuizzes" runat="server" AutoGenerateColumns="false" CssClass="table-admin"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="PassMark" HeaderText="Pass %" />
