...
namespace Techspire_LMS.Pages
{
    public partial class CourseDetails : System.Web.UI.Page
    {
        ...
        private void LoadCourse()
        {
            ...
            litMeta.Text = Server.HtmlEncode(course.DifficultyLevel + " · " + course.DurationDisplay);
            litDescription.Text = Server.HtmlEncode(course.FullDescription ?? course.ShortDescription);
