...
//
//   1. Save this file at the root of your Techspire_LMS project, next to
...
using Techspire_LMS.Helpers; // PasswordHelper — see the top-of-file comment



namespace Techspire_LMS.Tools
{
    internal class CreateAdmin
    {
        ...
        {
            Console.WriteLine("=================================================");
            Console.WriteLine(" Techspire_LMS — Create / Promote an Admin User");
            Console.WriteLine("=================================================");
            Console.WriteLine();
