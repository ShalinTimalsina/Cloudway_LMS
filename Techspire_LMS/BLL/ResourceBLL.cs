...
namespace Techspire_LMS.BLL
{
    ...
    public class ResourceBLL
    {
        ...
        private void Validate(Resource r)
        {
            ...
            if (string.IsNullOrWhiteSpace(r.Title)) throw new ValidationException("Resource title is required.");
            if (string.IsNullOrWhiteSpace(r.FilePath)) throw new ValidationException("Resource file path is required.");
            if (string.IsNullOrWhiteSpace(r.ResourceType)) r.ResourceType = "Document";
        }
    }
}
