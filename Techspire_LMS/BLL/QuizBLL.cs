...
namespace Techspire_LMS.BLL
{
    public class QuizBLL
    {
        ...
        /// the quiz's CURRENT questions and PassMark, then stored as a
        ...
        public QuizAttempt SubmitAttempt(int userId, int quizId, Dictionary<int, List<int>> answers)
        {
            ...
            bool isPassed = totalMarks > 0
                && ((decimal)score * 100m / totalMarks) >= quiz.PassMark;
        ...
        private void ValidateQuiz(Quiz q)
        {
            ...
            if (q.PassMark < 0 || q.PassMark > 100) throw new ValidationException("Pass mark must be between 0 and 100.");
        }
